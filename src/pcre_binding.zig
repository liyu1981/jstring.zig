// generated by: ` tools/translate_c_extract/zig-out/bin/translate_c_extract src/pcre/pcre_binding.h src/pcre/pcre_binding.autogen.zig `
// timestamp: 1704849511587960
...
pub const RegexContext = extern struct {
    ...
    regex_extra_options: u32 = @import("std").mem.zeroes(u32),
    ...
    group_names: [*c]RegexGroupName = @import("std").mem.zeroes([*c]RegexGroupName),
    group_name_count: usize = @import("std").mem.zeroes(usize),
    matched_count: usize = @import("std").mem.zeroes(usize),
    matched_result: RegexMatchResult = @import("std").mem.zeroes(RegexMatchResult),
    matched_group_count: usize = @import("std").mem.zeroes(usize),
    matched_group_capacity: usize = @import("std").mem.zeroes(usize),
    matched_group_results: [*c]RegexGroupResult = @import("std").mem.zeroes([*c]RegexGroupResult),
    re: ?*anyopaque = @import("std").mem.zeroes(?*anyopaque),
    match_data: ?*anyopaque = @import("std").mem.zeroes(?*anyopaque),
    compile_context: ?*anyopaque = @import("std").mem.zeroes(?*anyopaque),
};
