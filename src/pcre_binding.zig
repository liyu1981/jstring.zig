...
pub const offsetof = @compileError("unable to translate C expr: unexpected token 'an identifier'"); // /Users/bytedance/DevCamp/bun/.cache/zig/lib/include/stddef.h:116:9
